...
export class PlayerCobra {
    ...
    private fuel: number = PlayerCobra.MAX_FUEL;
    private missiles: number = PlayerCobra.DEFAULT_MISSILES;
    private readonly lasers: (Equipment | null)[] = [EquipmentStore.get().getEquipmentById(EquipmentStore.PULSE_LASER), null, null, null];
    ...
    private retroRocketsUseCount: number = 0;
    private retroRocketsTotalCount: number = 0;
    private frontShield: number = PlayerCobra.MAX_SHIELD;
    private rearShield: number = PlayerCobra.MAX_SHIELD;
    ...
    private laserTemperature: number = 0;
    private cabinTemperature: number = 0;
    private altitude: number = PlayerCobra.MAX_ALTITUDE;
    private pitch: number = 0;
    private roll: number = 0;
    private missileLocked: boolean = false;
    private missileTargeting: boolean = false;
    private laserOverheated: boolean = false;
    private travelledDistance: number = 0;
    private collisionAmount: number = 0;
    private hitByMissileCount: number = 0;
    private hitBySpaceStationCount: number = 0;
    private hitByLaserAmount: number = 0;
    private scoopAmount: number = 0;
    private scoopedTonnePlatlet: number = 0;
    private scoopedTonneAlien: number = 0;
    private scoopedTonneEscapeCapsule: number = 0;
    private ejectedAmount: number = 0;
    private wasLowEnergy: boolean = false;
    private lowEnergyCount: number = 0;
    private maxEquipments: number = 0;
    private scoopedFuel: number = 0;

    public setLaser(where: number, laser: Equipment | null): void {
        this.lasers[where] = laser;
        this.setMaxEquipments();
    }

    public getLaser(where: number): Equipment | null { return this.lasers[where]; }
    ...
    public addEquipment(equip: Equipment | null): void {
        if (!equip || this.equipmentInstalled.includes(equip)) {
            return;
        }
    ...
    private getLaserCount(where: number): number { return this.lasers[where] ? 1 : 0; }
    ...
    public isEquipmentInstalled(equip: Equipment): boolean { return this.equipmentInstalled.includes(equip); }
    public getInstalledEquipment(): Equipment[] { return this.equipmentInstalled; }
    ...
    public hasCargo(): boolean { return this.inventory.length > 0; }

    public getInventoryItemByGood(good: TradeGood): InventoryItem | null {
    ...
    public clearInventory(): void { this.inventory.length = 0; }
    public getMissiles(): number { return this.missiles; }
    public setMissiles(newMissileCount: number): void { this.missiles = Math.min(PlayerCobra.MAXIMUM_MISSILES, newMissileCount); }
    public getFuel(): number { return this.fuel; }
    public getMaxFuel(): number { return PlayerCobra.MAX_FUEL; }
    ...
    public getTravelledDistance(): number { return this.travelledDistance / 10; }
    public addCollision(amount: number): void { this.collisionAmount += amount; }
    public getCollisionAmount(): number { return this.collisionAmount; }
    public increaseHitByMissile(): void { this.hitByMissileCount++; }
    public getHitByMissileCount(): number { return this.hitByMissileCount; }
    public addHitByLaser(amount: number): void { this.hitByLaserAmount += amount; }
    public getHitByLaserAmount(): number { return this.hitByLaserAmount; }
    public increaseHitBySpaceStation(): void { this.hitBySpaceStationCount++; }
    public getHitBySpaceStationCount(): number { return this.hitBySpaceStationCount; }
    ...
    public getScoopAmount(): number { return this.scoopAmount / Unit.TONNE.getValue(); }
    public getScoopedTonnePlatlet(): number { return this.scoopedTonnePlatlet; }
    public getScoopedTonneAlien(): number { return this.scoopedTonneAlien; }
    public getScoopedTonneEscapeCapsule(): number { return this.scoopedTonneEscapeCapsule; }
    public getEjectedAmount(): number { return this.ejectedAmount / Unit.TONNE.getValue(); }
    ...
    public getRetroRocketsTotalCount(): number { return this.retroRocketsTotalCount; }
    public getLowEnergyCount(): number { return this.lowEnergyCount; }
    public getMaxEquipments(): number { return this.maxEquipments; }
    public addScoopedFuel(fuel: number): void { this.scoopedFuel += fuel; }
    public getScoopedFuel(): number { return this.scoopedFuel; }
    ...
    public getFrontShield(): number { return this.frontShield; }
    public getRearShield(): number { return this.rearShield; }
    ...
    public getEnergyBank(idx: number): number { return this.energyBank[idx]; }

    public setFrontShield(newVal: number): void {
        this.frontShield = Math.max(0, Math.min(newVal, PlayerCobra.MAX_SHIELD + Settings.shieldPowerOverride));
    }

    public setRearShield(newVal: number): void {
        this.rearShield = Math.max(0, Math.min(newVal, PlayerCobra.MAX_SHIELD + Settings.shieldPowerOverride));
    }
    ...
    public getLaserTemperature(): number { return this.laserTemperature; }
    ...
    private isLaserOverheated(): boolean { return this.laserTemperature >= PlayerCobra.MAX_LASER_TEMPERATURE * 0.85; }

    public getCabinTemperature(): number { return this.cabinTemperature; }
    public setCabinTemperature(temp: number): void { this.cabinTemperature = temp; }
    public getAltitude(): number { return this.altitude; }
    ...
    public isMissileLocked(): boolean { return this.missileLocked; }
    ...
    public isMissileTargetting(): boolean { return this.missileTargeting; }
    ...
    public toJson(): any {
        return {
            ...
            inventories: this.inventory.map(i => ({ goodId: i.getGood().getId(), ...i.toJson() })),
        };
    }
