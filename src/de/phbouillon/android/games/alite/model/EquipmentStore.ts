...
export class EquipmentStore {
    ...
    public static get(): EquipmentStore {
        if (!this.instance) {
            this.instance = new EquipmentStore();
        }
    ...
    public getEquipmentById(name: string): Equipment | null {
        return this.getEquipmentByHash(Equipment.getEquipmentId(name));
    }

    public getEquipmentByHash(id: number): Equipment | null {
    ...
    public getEquipmentCount(): number {
        return this.equipments.filter(e => e.allowToFit()).length;
    }
}
