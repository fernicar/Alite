...
export abstract class TradeGoodStore {
    ...
    private static instance: TradeGoodStore | null = null;
    protected readonly goods: TradeGood[] = [];
    ...
    public getGoodById(id: number): TradeGood | null {
